...
class [[eosio::contract]] bank : public eosio::contract {
    ...
    public:
         ...
         * Constructor
        **/
        bank( name receiver, name code, datastream<const char*> ds ): contract::contract( receiver, code, ds ),  total_deposit_table( receiver, receiver.value ) {}

        /**
         * Struct
        **/

        /// amount which sender account transfer to eosio.stokvel.token contract
